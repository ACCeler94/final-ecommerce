...
exports.resetCart = exports.recalculateTotalPrice = exports.addProductComment = exports.changeProductQuantity = exports.removeFromCart = exports.addToCart = exports.cartSlice = exports.resetCartInStorage = exports.loadCart = exports.storeCart = void 0;
...
exports.cartSlice = (0, toolkit_1.createSlice)({
    ...
    reducers: {
        ...
        removeFromCart: (state, action) => {
            state.shoppingCart = state.shoppingCart.filter((elem) => elem.product.id !== action.payload.product.id);
        },
        changeProductQuantity: (state, action) => {
            const elemToChange = state.shoppingCart.find((elem) => elem.product.id === action.payload.product.id);
            if (elemToChange)
...
_a = exports.cartSlice.actions, exports.addToCart = _a.addToCart, exports.removeFromCart = _a.removeFromCart, exports.changeProductQuantity = _a.changeProductQuantity, exports.addProductComment = _a.addProductComment, exports.recalculateTotalPrice = _a.recalculateTotalPrice, exports.resetCart = _a.resetCart;
