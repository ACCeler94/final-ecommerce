...
const Cart = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: Cart_module_css_1.default.cartProductList, children: [(0, jsx_runtime_1.jsx)("ul", { children: cart.map((cartObj, index) => {
                    return ((0, jsx_runtime_1.jsx)("li", { className: Cart_module_css_1.default.cartItemWrapper, children: (0, jsx_runtime_1.jsx)(CartItem_1.default, { ...cartObj, cart: cart }, index) }, index));
                }) }), (0, jsx_runtime_1.jsxs)("section", { className: Cart_module_css_1.default.cartSummary, children: [(0, jsx_runtime_1.jsxs)("p", { children: ["Total price: $", totalPrice] }), (0, jsx_runtime_1.jsx)(Button_1.default, { buttonText: "Checkout", buttonHandler: () => navigate('checkout'), type: "button" })] })] }));
};
