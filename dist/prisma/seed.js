    ...
    return [
        {
            ...
            description: 'You will adore this soft and comfortable cotton t-shirt from Breezy. This t-shirt has a crew neck, short sleeves, and a regular fit that gives it a casual and relaxed look. Warning: this design was made only for real book nerds!',
            sizes: 's, m, l, xl',
        },
        {
            ...
            description: 'A beautiful and feminine floral print dress that is ideal for any occasion. This dress features a v-neck, short sleeves, a fitted waist, and a flared skirt. It is made of lightweight and breathable fabric that is easy to care for.',
            sizes: 's, m, l, xl, xxl',
        },
        {
            ...
            description: 'You will rock these dark, distressed jeans from Denimix. These jeans are fitted and have visible wear and tear, giving them a rugged and cool look. They are made of durable and stretchy denim that offers a comfortable and flattering fit.',
            sizes: 's, m, l, xl, xxl',
        },
        {
            ...
            description: 'You will love this flirty and fashionable mini skirt from Pleatique. This mini skirt has an elastic waistband, a side zipper, and a pleated design that gives it a fun and flirty look. It is made of smooth and shiny fabric that adds some sparkle to your outfit.',
            sizes: 's, m, l',
        },
        {
        ...
        },
        {
            ...
            description: 'A stylish and edgy faux leather jacket that is a great addition to your wardrobe. This jacket features a lapel collar, long sleeves, a zip front, and zip pockets. It is made of faux leather that is smooth and sleek, and has a quilted lining for extra warmth.',
            sizes: 's, m, l',
        },
        {
        ...
        },
        {
            ...
            description: 'Wrap yourself in this cozy and cute cable knit sweater from Knitique. This sweater has a round neck, long sleeves, and a cable knit pattern that gives it a cozy and textured feel. It is made of wool and acrylic that are warm and soft, keeping you snug and comfy in the chilly weather.',
...
async function seed() {
    ...
    await Promise.all((await getUsers()).map((user) => {
